...
# public cpanell 
ALLOWED_HOSTS = ["tintuc.heightentertainment"]
- setting : 
   DATABASES = {
               'default': {
                  'ENGINE': 'django.db.backends.mysql',
                  'NAME': 'aqrlrlvi_nongsan',  # Tên cơ sở dữ liệu
                  'USER': 'aqrlrlvi_aqrlrlvi_user',  # Người dùng MySQL
                  'PASSWORD': 'D@t130103',  # Để trống nếu không có mật khẩu
                  'HOST': 'localhost',
                  "PORT": "3306",
                  }
               }
